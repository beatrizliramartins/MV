...
public class Menu {
		...
		public static void main(String[] args) {
			...
			int faz = 0;
			do {
				System.out.println("======Café MV======");
				System.out.println("Bem Vindo ao nosso café da manhã!");
				System.out.println("Digite 1 para inserir participante,\n"
								+ "       2 para remover participante,\n"
								+ "       3 para pesquisar participante,\n"
								+ "       4 para Listar participantes e Itens já escolhidos,\n"
								+ "       5 para sair");
				...
				case 1: 
					...
					System.out.println("Digite o item que irá trazer:");
				...
				case 4: 
					...
					System.out.println("Item à trazer:"  +participante.getItemTrazido());
